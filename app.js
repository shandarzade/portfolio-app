...
var logos = [
  ...
  '<i style="color: #61dbfb;" class="fab fa-angular"></i>',
...
// const apiUrl = 'http://localhost:8000/email/';
...
//   const message = $('#message-me').val().trim();
...
//   $.post(apiUrl, data, (res, status) => {
//     alert('Response: ' + res + ', Status: ', status);
//   });
// });
